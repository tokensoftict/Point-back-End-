...
export default {
    ...
    computed: {
        categoryService() {
            return new CategoryService(this.$api)
        },
    ...
    methods: {
        ...
        edit(category) {
            ...
            for (let key in category) {
               ...
               if(typeof this.$refs["update_" + key] !== "undefined"){
                   ...
                   this.$refs["update_" + key].setValue(category[key]);
        ...
        updateCategory() {
            if (this.$helper.validateSingle(this.$refs, this.update_controls) === false) {
                ...
                this.categoryService.update(storedata, this.update.id)
                    .then((response) => {
                        this.$refs.update_button.toggleProcessing();
                        this.get();
        ...
        toggle(id) {
            this.$refs.category_table.setLoadingState(true);
            this.categoryService.toggle(id).then((response) => {
                this.get();
            })
        },
        ...
        delete_row(id) {
            this.$refs.category_table.setLoadingState(true);
            this.categoryService.remove(id).then((response) => {
                this.get();
            })
        },
        ...
        get() {
            ...
            this.categoryService.get().then((response) => {
                ...
                this.$refs.category_table.setLoadingState(false);
            });
        },
        ...
        save() {
            ...
            if (this.$helper.validateSingle(this.$refs, this.new_controls) === false) {
                ...
                this.categoryService.post(storedata)
                    .then((response) => {
                        this.$refs.submit_button.toggleProcessing();
                        this.get();
                        this.$notify({
