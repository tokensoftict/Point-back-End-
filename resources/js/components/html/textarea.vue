<template>
    <textarea ref="textarea"  :name="name" :validate="validate" :type="type" :placeholder="placeholder" :class="{
...
export default {
    ...
    methods: {
        ...
        is_valid() {
            ...
            if(this.$refs.textarea.value.length > 0) return true;
        },
